...
const authGaurd = (...requiredRoles) => {
    return (0, catchAsync_1.default)(async (req, res, next) => {
        ...
        if (!token) {
            throw new AppError_1.default(http_status_1.httpStatus.UNAUTHORIZED, "You are not authorized");
        }
        ...
        if (!user) {
            throw new AppError_1.default(http_status_1.httpStatus.UNAUTHORIZED, "You are not eligible for this oparation");
        }
        // checking
        if (requiredRoles && !requiredRoles.includes(role)) {
            throw new AppError_1.default(http_status_1.httpStatus.UNAUTHORIZED, "You are not eligible");
        }
        req.user = decoded;
        next();
    });
